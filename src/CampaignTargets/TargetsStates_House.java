	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		File _congressMainPage = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
							try {
								...
								System.out.println("=====================================================");	
								Thread.sleep(3000);					
								FileUtils.copyFile(_congressMainPage, new File("/Users/jahsavaged/Desktop/CiviTestScreenshot/Targets/StatesHouse/TargetsMainPage.png"));   	           
								Thread.sleep(2000);												
							} catch (IOException e) {
		...
		// 					// Thread.sleep(3000);
						...
						File _statesPage = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
							try {
								...
								System.out.println("=====================================================");	
								Thread.sleep(3000);					
								FileUtils.copyFile(_statesPage, new File("/Users/jahsavaged/Desktop/CiviTestScreenshot/Targets/StatesHouse/StatesPage.png"));   	           
								Thread.sleep(2000);												
							} catch (IOException e) {
								System.out.println(e.getMessage());
							}
								...
								Thread.sleep(6000);
										...
										Thread.sleep(8000);
												...
												try {
													...
													System.out.println("=====================================================");	
													Thread.sleep(12000);					
													FileUtils.copyFile(_state, new File("/Users/jahsavaged/Desktop/CiviTestScreenshot/Targets/StatesHouse/State_House_SelectedTargets.png"));   	           
													Thread.sleep(3000);												
												} catch (IOException e) {
													System.out.println(e.getMessage());
												}
													...
													File _addedTargets = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
																try {
																	...
																	System.out.println("=====================================================");	
																	Thread.sleep(8000);					
																	FileUtils.copyFile(_addedTargets, new File("/Users/jahsavaged/Desktop/CiviTestScreenshot/Targets/StatesHouse/StateView_House_AddedTargets.png"));   	           
																	Thread.sleep(2000);												
																} catch (IOException e) {
																	System.out.println(e.getMessage());
																}																	
																	...
																	File _removeAllTargets = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
																				try {
																					...
																					System.out.println("=====================================================");	
																					Thread.sleep(9000);					
																					FileUtils.copyFile(_removeAllTargets, new File("/Users/jahsavaged/Desktop/CiviTestScreenshot/Targets/StatesHouse/State_House_RemoveAllTargets.png"));   	           
																					Thread.sleep(1000);												
																				} catch (IOException e) {
																					System.out.println(e.getMessage());
																				}	
