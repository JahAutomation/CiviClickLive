...
public class Display_ImageHeader_Style {
	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		_gotoDisplayTab.click();
						...
						//System.out.println("=====================================================");
						System.out.println("Clicking Image Style..");
						System.out.println("=====================================================");
						Thread.sleep(500);
										...
										if(!handles.equals(parentID)) {	
											Thread.sleep(5000);	
												...
												try {
										            ...
										            FileUtils.copyFile(screenshotMid, new File("/Users/jahsavaged/Desktop/CiviTestScreenshotLive/DisplayImageBackground/ImageHeader.png"));   	           
										            Thread.sleep(2000);
